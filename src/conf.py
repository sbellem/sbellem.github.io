...
# gluon build configuration file, created by
# `ablog start` on Wed Sep  1 15:52:08 2021.
#
...
blog_title = "gluon Blog"

# Base URL for the website, required for generating feeds.
# e.g. blog_baseurl = "http://example.com/"
blog_baseurl = "https://sbellem.github.io"
...
blog_authors = {
    "Sylvain Bellemare": ("Sylvain Bellemare", None),
}
